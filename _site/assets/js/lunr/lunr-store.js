var store = [{
        ...
        "excerpt":"git stash를 사용하는 이유 한 브랜치에서 작업을 하다가 다른 브랜치로 checkout 해야하는 경우가 있습니다. 이때 git checkout [브랜치]를 사용하면 다음과 같은 오류를 만나게 됩니다. rror: Your local changes to the following files would be overwritten by checkout: _posts/2021-03-17-gitStash.md Please, commit your changes or stash them before you can switch branches....","categories": [],
        "tags": ["github"],
        "url": "/gitStash/",
        "teaser": null
      },{
        "title": "비전공자로 개발자 커리어를 시작하기",
        "excerpt":"최근 개발자에 대한 수요가 많아지고, 대우가 좋아지면서 대학교에서 CS를 전공하지 않은 비전공자 개발자들이 많아지고 있습니다. 저 또한 CS가 아닌 다른 과목을 전공했지만 현재 AI 스타트업에서 개발자로 일하고 있습니다. 비전공자로 개발자 커리어를 이어나갈 때 여러 어려움을 겪게 되는데요. 대표적으로, CS 기반 지식의 깊이가 얇고 업무 효율성이 떨어진다. 운영체제, 데이터베이스(인덱싱, 파티셔닝, 파일시스템),...","categories": [],
        "tags": ["github"],
        "url": "/Seungineer1/",
        "teaser": null
      },{
